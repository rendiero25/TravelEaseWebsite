...
const TopCategories = () => {
    ...
    return(
        <div className="px-6 sm:px-12 xl:px-22 3xl:px-42 4xl:px-80">
            ...
            {/*    {categories.map((categorydata) => (*/}
            {/*        <div key={categorydata.id} className="overflow-hidden">*/}
            {/*            <div className="h-full w-full pt-10 bg-red-500 overflow-hidden">*/}
            {/*                <div className="relative w-[27rem] h-[27rem] 4xl:h-[30rem] overflow-hidden">*/}
            {/*                    <img src={categorydata.imageUrl} alt="categories-image" className="w-full h-full object-cover"/>*/}
