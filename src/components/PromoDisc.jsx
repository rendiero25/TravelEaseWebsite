...
const PromoDisc = () => {
    ...
    return(
        <div style={{backgroundImage: `url(${TopRatedExpBg})`}} className="relative pt-20 sm:pt-30 4xl:pt-40 pb-20 sm:pb-30 4xl:pb-40 px-6 sm:px-12 xl:px-22 3xl:px-42 4xl:px-80 h-[42rem] sm:h-[41rem] xl:h-[40rem] 4xl:h-[47rem]">
            <div className="flex flex-col justify-between items-start gap-4 4xl:gap-8">
                <h2 className="font-bold text-4xl sm:text-5xl xl:text-6xl 3xl:text-7xl text-white">Explore, Make Dreams Come True</h2>
