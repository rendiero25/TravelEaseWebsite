...
const Header = () => {
    ...
    return(
        <div className="px-6 sm:px-12 xl:px-22 3xl:px-42 4xl:px-80 py-2 w-full border-b-[0.03rem] border-white/25 flex justify-between items-center shadow-black/10 shadow-2xl">
            ...
            <div className="w-50vw xl:hidden">
                <Button onClick={toggleMobileMenu} className="flex">
                    <BiMenuAltRight className="size-8 text-black -mr-11"/>
                </Button>
            </div>
            ...
            <div className="hidden xl:flex flex-row justify-between items-center gap-4">
                <div className="flex flex-row justify-between items-center gap-2">
                    <Button onClick={toLogin} variant="text" startIcon={<BiRightArrowCircle/>} style={{color:"white", fontWeight:"400", textTransform:"none", fontSize:"14px"}}>Sign In</Button>
